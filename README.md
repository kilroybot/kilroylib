...
For more info about the package itself see `kilroylib/README.md` or [docs](https://kilroybot.github.io/kilroylib).
...
To start first write the tests and put them in `kilroylib/tests`.
...
Docs should be placed in `kilroylib/docs/docs`.
